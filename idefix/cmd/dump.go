...
import (
	...
	"idefix/internal/asxreader"
	"idefix/internal/decoder"
	"idefix/internal/stats"
...
information in a human-readable format.`,
  ...
  idefix dump -p 10001/udp --dump021 --dump062`,
	...
	dumpCmd.Flags().BoolVar(&dumpCat001, "dump001", false, "Dump ASTERIX category 001 (Monoradar Plot)")
	dumpCmd.Flags().BoolVar(&dumpCat002, "dump002", false, "Dump ASTERIX category 002 (Monoradar Service)")
	...
	dumpCmd.Flags().BoolVar(&dumpCat023, "dump023", false, "Dump ASTERIX category 023 (CNS/ATM Ground Station)")
	...
	// Version flags for categories with multiple versions
	dumpCmd.Flags().StringVar(&cat048Version, "cat048version", "1.32", "CAT048 version to use (1.17 or 1.32)")
...
func processMessages(
	...
	for {
		...
		// Update statistics
		msgStats.IncrementCategory(msg.Category(), msg.RecordCount())
