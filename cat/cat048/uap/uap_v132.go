...
func (u *UAP048) Validate(items map[string]asterix.DataItem) error {
	...
	// Note: The CAT048 specification states that I048/040 (Measured Position)
	// shall be sent when there is a detection (TYP != 0 in I048/020).
	// However, some radar implementations may not follow this rule strictly,
	// so we don't enforce it during decode for interoperability.
