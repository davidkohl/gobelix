// Package cat048 provides ASTERIX Category 048 (Monoradar Target Reports) implementation.
package cat048
...
func NewUAP(version string) (asterix.UAP, error) {
	...
	default:
		return nil, fmt.Errorf("unsupported CAT048 version: %s (available: %v)", version, AvailableVersions())
	}
}
...
func AvailableVersions() []string {
	return []string{Version117, Version132}
}
