...
func (u *UAP020) CreateDataItem(id string) (asterix.DataItem, error) {
	...
	case "I020/020":
		return &cat020.TargetReportDescriptor{}, nil
	case "I020/140":
		return &common.TimeOfDay{}, nil
	case "I020/041":
		return &cat020.PositionWGS84{}, nil
	case "I020/042":
		return &cat020.PositionCartesian{}, nil
	case "I020/161":
		return &common.TrackNumber{}, nil
	case "I020/170":
		return &cat020.TrackStatus{}, nil
	case "I020/070":
		return &cat020.Mode3ACode{}, nil
	case "I020/202":
		return &cat020.TrackVelocityCartesian{}, nil
	case "I020/090":
		return &cat020.FlightLevel{}, nil
	case "I020/100":
		return &cat020.ModeCCode{}, nil
	case "I020/220":
		return &common.TargetAddress{}, nil
	case "I020/245":
		return &cat020.TargetIdentification{}, nil
	case "I020/110":
		return &cat020.MeasuredHeight{}, nil
	case "I020/105":
		return &cat020.GeometricHeight{}, nil
	case "I020/210":
		return &cat020.CalculatedAcceleration{}, nil
	case "I020/300":
		return &cat020.VehicleFleetIdentification{}, nil
	case "I020/310":
		return &cat020.PreProgrammedMessage{}, nil
	case "I020/500":
	...
	case "I020/230":
		return &cat020.CommunicationsCapability{}, nil
	case "I020/260":
		return &cat020.ACASResolutionAdvisory{}, nil
	case "I020/030":
		return &cat020.WarningErrorConditions{}, nil
	case "I020/055":
		return &cat020.Mode1Code{}, nil
	case "I020/050":
		return &cat020.Mode2Code{}, nil
	case "RE020":
