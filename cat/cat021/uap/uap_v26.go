...
func (u *UAP26) CreateDataItem(id string) (asterix.DataItem, error) {
	...
	case "I021/151":
		return &v26.TrueAirSpeed{}, nil
	case "I021/157":
		return &v26.GeometricVerticalRate{}, nil
	case "I021/160":
		return &v26.AirborneGroundVector{}, nil
	case "I021/165":
		return &v26.TrackAngleRate{}, nil
	case "I021/016":
		return &v26.ServiceManagement{}, nil
	case "I021/110":
		return &v26.TrajectoryIntent{}, nil
	case "I021/131":
		return &v26.PositionHighRes{}, nil
	case "I021/132":
		return &v26.MessageAmplitude{}, nil
	case "I021/140":
		return &v26.GeometricHeight{}, nil
	case "I021/146":
		return &v26.SelectedAltitude{}, nil
	case "I021/148":
		return &v26.FinalStateSelectedAltitude{}, nil
	case "I021/220":
		return &v26.MetInformation{}, nil
	case "I021/230":
		return &v26.RollAngle{}, nil
	case "I021/250":
		return &v26.ModeSMBData{}, nil
	case "I021/260":
		return &v26.ACASResolutionAdvisory{}, nil
	case "I021/271":
