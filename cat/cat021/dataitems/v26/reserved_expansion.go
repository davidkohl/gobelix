...
// Reserved Expansion implements "Part 12 Category 021 - ADS-B Target Reports - Appendix A: Reserved Expansion Field
// WARNING : PARTIALLY IMPLEMENTED YET to let the decoder decode the full buffer.
