// cat/cat001/uap/uap_v12_track.go
package uap
...
// UAP12Track implements the User Application Profile for ASTERIX Category 001 v1.2 Track Messages
type UAP12Track struct {
	*asterix.BaseUAP
}

// NewUAP12Track creates a new instance of the Category 001 v1.2 Track UAP
func NewUAP12Track() (*UAP12Track, error) {
	base, err := asterix.NewBaseUAP(asterix.Cat001, "1.2", cat001TrackFields)
	if err != nil {
		return nil, err
	}
...
func (u *UAP12Track) CreateDataItem(id string) (asterix.DataItem, error) {
	switch id {
	case "I001/010":
...
// Validate implements validations for Cat001 Track messages
func (u *UAP12Track) Validate(items map[string]asterix.DataItem) error {
	// First do base validation (mandatory fields)
	if err := u.BaseUAP.Validate(items); err != nil {
		return err
	}

	// No additional validations needed for Cat001 tracks
	return nil
}

// cat001TrackFields defines the Track UAP for Category 001 v1.2 (Table 3)
// Based on EUROCONTROL specification Part 2a Edition 1.4, page 34
var cat001TrackFields = []asterix.DataField{
	{
		FRN:         1,
		DataItem:    "I001/010",
	...
	// FRN 20: Reserved for SP Indicator
	// FRN 21: Reserved for RFS Indicator
	// FX - Field Extension Indicator
	{
		FRN:         22,
		DataItem:    "I001/150",
