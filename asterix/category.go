...
const (
	...
	Cat011 Category = 11  // A-SMGCS Data Reports
	Cat020 Category = 20  // Multilateration Target Reports
	Cat021 Category = 21  // ADS-B Reports
	Cat023 Category = 23  // CNS/ATM Ground Station and Service Status Reports
...
func (c Category) IsValid() bool {
	switch c {
	case Cat001, Cat002, Cat011, Cat020, Cat021, Cat023, Cat034, Cat048, Cat062, Cat063, Cat065, Cat247, Cat252:
		return true
	default:
...
func (c Category) IsBlockable() bool {
	switch c {
	case Cat001, Cat002, Cat011, Cat021, Cat023, Cat034, Cat048, Cat062, Cat063, Cat065, Cat247:
		return true
	default:
		return false
	}
...
func GetCategoryInfo(cat Category) CategoryInfo {
	...
	case Cat011:
		return CategoryInfo{
			Number:      Cat011,
			Name:        "CAT011",
			Description: "A-SMGCS Data Reports",
			Version:     "1.3",
			Blockable:   true,
		}
	case Cat020:
	...
	case Cat023:
		return CategoryInfo{
			Number:      Cat023,
			Name:        "CAT023",
			Description: "CNS/ATM Ground Station and Service Status Reports",
			Version:     "1.3",
			Blockable:   true,
		}
	case Cat034:
